...
var DashboardLayout = require('react-proxy-plus?name=page-normal!./components/DashboardLayout');
...
var routes = (
  <Route name="app" path='/' handler={App}>
    <DefaultRoute handler={DashboardLayout}/>
    <Route name="page-home" path='normal' handler={PageHome}/>
